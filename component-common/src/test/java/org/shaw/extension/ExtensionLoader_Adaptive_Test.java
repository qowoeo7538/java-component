...
import org.shaw.extension.adaptive.impl.HasAdaptiveExtManualAdaptive;
import org.shaw.extension.ext1.SimpleExt;
import org.shaw.extension.ext2.Ext2;
import org.shaw.extension.ext2.UrlHolder;
import org.shaw.extension.ext3.UseProtocolKeyExt;
import org.shaw.extension.ext4.NoUrlParamExt;
import org.shaw.extension.ext6_inject.Ext6;
import org.shaw.extension.ext6_inject.impl.Ext6Impl2;
...
public class ExtensionLoader_Adaptive_Test {
    ...
    public void test_getAdaptiveExtension_inject() throws Exception {
        ...
        Assert.assertEquals("Ext6Impl1-echo-Ext1Impl1-echo", ext.echo(url, "ha"));

        url = url.addParameters("simple.ext", "impl2");
        Assert.assertEquals("Ext6Impl1-echo-Ext1Impl2-echo", ext.echo(url, "ha"));
    }
